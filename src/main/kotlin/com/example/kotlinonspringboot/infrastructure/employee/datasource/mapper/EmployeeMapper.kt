...
interface EmployeeMapper {
    @Select("SELECT EMPLOYEE_NUMBER, FULL_NAME,AGE,EMAIL_ADDRESS FROM EMPLOYEE ORDER BY EMPLOYEE_NUMBER DESC")
    fun findAllSortedListByKeyDesc(): List<EmployeeEntity>
